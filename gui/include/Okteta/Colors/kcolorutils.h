 ...
 * @since 5.68
 */
OKTETAGUI_EXPORT qreal hue(const QColor &);
 ...
 * @since 5.68
 */
OKTETAGUI_EXPORT qreal chroma(const QColor &);
 ...
 */
OKTETAGUI_EXPORT qreal luma(const QColor &);
 ...
 * @since 5.0
 */
OKTETAGUI_EXPORT void getHcy(const QColor &, qreal *hue, qreal *chroma, qreal *luma, qreal *alpha = nullptr);
 ...
 * @since 5.68
 */
OKTETAGUI_EXPORT QColor hcyColor(qreal hue, qreal chroma, qreal luma, qreal alpha = 1.0);
 ...
 */
OKTETAGUI_EXPORT qreal contrastRatio(const QColor &, const QColor &);
 ...
 */
OKTETAGUI_EXPORT QColor lighten(const QColor &, qreal amount = 0.5, qreal chromaInverseGain = 1.0);
 ...
 * @see KColorUtils::shade
 */
OKTETAGUI_EXPORT QColor darken(const QColor &, qreal amount = 0.5, qreal chromaGain = 1.0);
 ...
 * @see KColorUtils::luma
 */
OKTETAGUI_EXPORT QColor shade(const QColor &, qreal lumaAmount, qreal chromaAmount = 0.0);
 ...
 * 1.0 gives @p color
 */
OKTETAGUI_EXPORT QColor tint(const QColor &base, const QColor &color, qreal amount = 0.3);
 ...
 * and @p c2.
 */
OKTETAGUI_EXPORT QColor mix(const QColor &c1, const QColor &c2, qreal bias = 0.5);
 ...
 */
OKTETAGUI_EXPORT QColor overlayColors(const QColor &base, const QColor &paint, QPainter::CompositionMode comp = QPainter::CompositionMode_SourceOver);
}

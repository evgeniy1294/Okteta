...
int ClipboardController::addContextMenuActions(QMenu* menu)
{
    auto copyAction = menu->addAction(QIcon::fromTheme(QStringLiteral("edit-copy")),
                                      QObject::tr("&Copy") + QLatin1Char('\t') + QKeySequence(QKeySequence::Copy).toString(QKeySequence::NativeText),
    ...
    auto cutAction = menu->addAction(QIcon::fromTheme(QStringLiteral("edit-cut")),
                                     QObject::tr("&Cut") + QLatin1Char('\t') + QKeySequence(QKeySequence::Cut).toString(QKeySequence::NativeText),
    ...
    auto pasteAction = menu->addAction(QIcon::fromTheme(QStringLiteral("edit-paste")),
                                       QObject::tr("&Paste") + QLatin1Char('\t') + QKeySequence(QKeySequence::Paste).toString(QKeySequence::NativeText),
